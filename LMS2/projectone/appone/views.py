...
# List Modules
class ModuleListView(UserPassesTestMixin, ListView):
    model = Module
...
class UserAssignmentListView(LoginRequiredMixin, ListView):
    ...
    template_name = 'user_assignment_list.html'
...
# Add User Assignment:
class UserAssignmentCreateView(CreateView):
    model = UserAssignment
    form_class = UserAssignmentForm
    template_name = 'user_assignment_form.html'
    success_url = reverse_lazy('user_assignment_list')

# Edit User Assignment:
class UserAssignmentUpdateView(UpdateView):
    model = UserAssignment
    form_class = UserAssignmentForm
    template_name = 'user_assignment_edit.html'
    success_url = reverse_lazy('user_assignment_list')

# Delete User Assignment:
class UserAssignmentDeleteView(DeleteView):
    model = UserAssignment
    template_name = 'user_assignment_confirm_delete.html'
    success_url = reverse_lazy('user_assignment_list')
