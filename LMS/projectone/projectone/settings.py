...
SECRET_KEY = 'django-insecure-&!l*kp0*%6z%^*eip4@^%1%&)oub3djpe-wzb3+yiy0qer1g&2'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Where your static files are stored during development
